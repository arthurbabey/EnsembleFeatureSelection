...
from src.feature_selection_methods import feature_selection_mutual_info, feature_selection_random_forest, feature_selection_f_statistic
from src.merging_strategy_methods import merging_strategy_union_of_pairwise_intersections
...
def pipeline_instance():
    ...
    pipeline = FeatureSelectionPipeline(data=data, fs_methods=fs_methods, merging_strategy=merging_strategy,
                                        classifier=classifier, num_repeats=num_repeats, threshold=threshold, task=task)
